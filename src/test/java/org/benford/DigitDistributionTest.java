...
public class DigitDistributionTest {
  ...
  private static final DigitSeries EXPECTED_Z_SCORE = new DigitSeries(new double[]{
          1.769923893,
          2.379742763,
          2.586727806,
          0.9643296328,
  ...
  @Test
  void getZscore() {
    DigitSeries zscore = BENFORD_DISTRIBUTION.getZscore(SECOND_DIGIT_DISTRIBUTION);
